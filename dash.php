...
footer {
	...
	<div id="main">
		<div class="head">
			<div class="col-div-6">
	        <span style="font-size:30px;cursor:pointer; color: rgb(6, 6, 6);" class="nav"  ><i class='bx bx-menu'></i>DASHBOARD</span>
		...
		<div class="col-div-3">
			<div class="box">
				<p>
					...
					$sql = "SELECT * FROM `tbl_hardware` WHERE 1";
					...
					mysqli_close($conn);
					?>
					<br/><span style="color:white; font-weight: bold; font-family: system-ui;">HARDWARE ITEM</span></p>
				<i class="fa fa-television box-icon" style="color:white"></i>
			</div>
		</div>
		<div class="col-div-3">
			<div class="box">
				<p>
					...
					$sql = "SELECT * FROM `tbl_software` WHERE 1";
					if ($result = mysqli_query($conn, $sql)) {
						$rowcount = mysqli_num_rows( $result );
						printf(" %d", $rowcount);
					 }
					...
					mysqli_close($conn);
					?>	
				<br/><span style="color:white; font-weight: bold; font-family: system-ui;">SOFTWARE ITEM</span></p>
				<i class="fa fa-gears box-icon" style="color:white"></i>
			</div>
		</div>
		<div class="col-div-3">
			<div class="box">
				...
				<?php
					...
					$sql = "SELECT * FROM `tbl_projectmanager` WHERE 1";
					if ($result = mysqli_query($conn, $sql)) {
						$rowcount = mysqli_num_rows( $result );
						printf(" %d", $rowcount);
					 }
					...
					mysqli_close($conn);
					?>		
				<br/><span style="color:white; font-weight: bold; font-family: system-ui;">PROJECT</span></p>
				<i class="fa fa-cubes box-icon" style="color:white"></i>
			</div>
		</div>
		<div class="col-div-3">
			<div class="box">
...
<div class="col-div-3">
	...
	<footer>
		<div style="text-align: center;">
			<a href="dash_report.php" class="btn btn-success">Generate Report&nbsp;<i class="fa fa-print" aria-hidden="true"></i></a>
		</div>
	</footer>
