...
<body>
	...
	<div id="main">
		<div class="head">
			<div class="col-div-6">
	        <span style="font-size:30px;cursor:pointer; color: rgb(6, 6, 6);" class="nav"  ><i class='bx bx-menu'></i>HARDWARE ASSET INVENTORY</span>
	        <span style="font-size:30px;cursor:pointer; color: black;" class="nav2"  ><i class='bx bx-menu'></i></span>
           <br/> <br/>
             <!--table start-->
     <div class="container mt-4">
     <table class="table table-striped table-bordered">
     <form action="http://localhost/my_suit/add_hardware.php" method="post">
      <tr>
     <td><label for="assetId">Asset ID:</label>
        ...
        <td><input type="submit" value="Add Asset" class="btn btn-primary"></form></td></tr></table>
        ...
        <table id="dataTable" class="table table-striped table-bordered">
        <form action="http://localhost/my_suit/edit_hardware_asset.php" method="post">
          ...
          <?php
              ...
              ?>
                  ...
                  <tr><td><form action="http://localhost/my_suit/delete_hardware_asset.php" method="post">
          ...
          <td><a href="http://localhost/my_suit/pdf_generate/hardware_asset_report.php"><button class="btn btn-success">Generate Report&nbsp;<i class="fa fa-print" aria-hidden="true"></i></button></a></td>
          </td>
        </table>
    </div>
     <!--table end-->
