...
<body>
    ...
    <a href="http://localhost/my_suit/projectDash.php" class="icon-a"><i class="fa fa-dashboard icons"></i>   Project-Dashboard</a>
	  <a href="http://localhost/my_suit/manager_asset.php"class="icon-a"><i class="fa fa-paper-plane icons"></i>   Project-Request Asset</a>
	  <a href=""class="icon-a"><i class="fa fa-gg icons"></i>   Project-Inventory</a>
	  <a href="index.html"class="icon-a"><i class="fa fa-sign-out icons"></i>Log-Out</a>
	</div>
	<div id="main">
		<div class="head">
			<div class="col-div-6">
	        <span style="font-size:30px;cursor:pointer; color: rgb(6, 6, 6);" class="nav"  ><i class='bx bx-menu'></i>MANAGER</span>
	        <span style="font-size:30px;cursor:pointer; color: black;" class="nav2"  ><i class='bx bx-menu'></i></span><h2>HARDWARE ASSET DETAILS</h2>
           <br/> <br/>
             <!--table start-->
        ...
        <form action="http://localhost/my_suit/add_manager_request.php" method="post">
          ...
          <?php
              ...
              ?>
                  ...
                  <input type="number" name="assetQty" required></td></tr>
