...
<body>
	...
	<div id="main">
		<div class="head">
			<div class="col-div-6">
	        <span style="font-size:30px;cursor:pointer; color: rgb(6, 6, 6);" class="nav"  ><i class='bx bx-menu'></i>PROJECT ASSET INVENTORY</span>
	        <span style="font-size:30px;cursor:pointer; color: black;" class="nav2"  ><i class='bx bx-menu'></i></span>
           <br/> <br/>
             <!--table start-->
     <div class="container mt-4"><h2>PROJECT ASSET INVENTORY.</h2></span>
